...
export const publicaciones: Publicacion[] = [
  ...
  },
  {
    ...
    paginas: [
      {
        ...
        pie: 'Fotografía familiar colectiva de la familia Gómez Bosch. Tom Gómez Arroyo, nieto de Tomás Gómez Arroyo, confirmó que su abuelo aparece en ella — es la única fotografía de las 717 páginas del libro donde la familia lo reconoció. No se documenta una posición exacta dentro de la foto.',
      },
      {
    ...
    identificacion: 'Fotografía de la página 7 confirmada directamente por la familia (Tom Gómez Arroyo, nieto); autoría de la carta de la página 144 acreditada por la firma impresa en la propia publicación.',
